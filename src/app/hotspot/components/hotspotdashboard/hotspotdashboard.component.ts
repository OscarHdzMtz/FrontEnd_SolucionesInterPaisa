...
export class HotspotdashboardComponent implements OnInit {
    ...
    constructor(
        private _HotspotuserprofileService: HotspotuserprofileService,
        private _HotspotusersService: HotspotusersService,
        private _HotspotactiveusersService: HotspotactiveusersService,
        private _HotspotserverService: HotspotserverService,
        private _HotspothostsService: HotspothostsService
    ) {}
    ...
    obtenerPerfilFichas() {
        this._HotspotuserprofileService
            .getHotspotUserProfilesService()
            .subscribe(
                (data) => {
                    /* console.log(data); */
    ...
    obtenerUsuariosFichasActivos() {
        this._HotspotactiveusersService
            .getHotspotActiveUsersService()
            .subscribe(
                (data) => {
